...
def main():
    params = {'memory_length': 5, # 'topic_change': 0.1, 
    ...
    recommender =  LibFM(num_user_features=0, num_item_features=0, num_rating_features=0, max_num_users=100, max_num_items=170) # TopPop() # KNNRecommender() #
