...
from reclab.recommenders import ItemKNN
...
def main():
    ...
    recommender = ItemKNN() # TopPop() # LibFM(num_user_features=0, num_item_features=0, num_rating_features=0, max_num_users=100, max_num_items=170)
